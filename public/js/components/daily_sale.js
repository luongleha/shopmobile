...
/***/ "./resources/js/components/daily_sale.js":
/*!***********************************************!*\
  !*** ./resources/js/components/daily_sale.js ***!
  \***********************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $('body').on('click', '.create-daily-sale-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-daily-sales/create';
    ...
    if ($('.create-total-quantity').val() !== '' && $('.create-total-money').val() !== '') {
      $.ajax({
        ...
        success: function success(data) {
          ...
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Chốt thành công');
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể chốt');
        }
      });
    }
  }); ///////PAGINATE////////
...
/***/ 8:
/*!*****************************************************!*\
  !*** multi ./resources/js/components/daily_sale.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
