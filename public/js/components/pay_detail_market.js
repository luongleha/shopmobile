...
/***/ "./resources/js/components/pay_detail_market.js":
/*!******************************************************!*\
  !*** ./resources/js/components/pay_detail_market.js ***!
  \******************************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $('body').on('click', '.show-market-btn', function () {
    ...
    console.log(id);
    $('.show-id-bill').val(id);
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay-detail/detail';
    $.get(full_path, {
      id: id
    }, function (data) {
  ...
  function fetch_data(page) {
    $.ajax({
      url: "/admin/market-pay-detail/list?page=" + page,
      success: function success(data) {
        $('#fb-market-append').empty();
        $('#fb-market-append').html(data.data);
        Object(_main__WEBPACK_IMPORTED_MODULE_1__["addOrdinalNumber"])('.table-pay-detail-market');
      }
    });
  } ///////END-PAGINATE////////
  ///////*************************************************////////
  ...
  function search() {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/logsearch'; // var cate = $('#cate').val();
...
/***/ 4:
/*!************************************************************!*\
  !*** multi ./resources/js/components/pay_detail_market.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
