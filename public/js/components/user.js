...
$(document).ready(function () {
  ...
  $('body').on('click', '.create-user-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/create';
    ...
    if ($('.create-name').val() !== '' && $('.create-email').val() !== '' && $('.create-pass').val() !== '' && $('.create-is-admin').val() !== '' && $('.create-image').val() !== '') {
      $.ajax({
        ...
        success: function success(data) {
          ...
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Tạo đơn nhân viên thành công');
          $('#user-append').html(data.data);
          Object(_main__WEBPACK_IMPORTED_MODULE_1__["addOrdinalNumber"])('.table-user');
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể tạo nhân viên');
        }
      });
    } else {
      if ($('.create-name').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào tên nhân viên');
      }

      if ($('.create-email').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào email nhân viên');
      }

      if ($('.create-pass').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào mật khẩu');
      }

      if ($('.create-image').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng chọn ảnh nhân viên');
      }

      if ($('.create-is-admin').val() == '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng chọn chức vụ nhân viên');
      }
    }
  }); ///////END-CREATE////////
  //     ///////*************************************************////////
  ...
  $('body').on('click', '.edit-user-btn', function () {
    ...
    $('.edit-id-user').val(id);
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/detail';
    $.get(full_path, {
      id: id
    }, function (data) {
      // if (data.code && data.code === 200) {
      ...
      $('.edit-pass').val(data.users.password); // var acc = data.users.is_admin;
  ...
  $('body').on('click', '.edit-user-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/update';
    var formData = new FormData();
  ...
  $('body').on('click', '.delete-user-submit', function () {
    ...
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/delete';
    $.post(full_path, {
      id: id
    }, function (data) {
      if (data.code && data.code === 200) {
        ...
        var _full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/list?page=' + curPage;

        console.log(_full_path);
        $(trow).remove();
        $.get(_full_path, function (data) {
          if (data.code && data.code === 200) {
            _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Xoá đơn nhân viên thành công');
            $('#user-append').html(data.data);
            Object(_main__WEBPACK_IMPORTED_MODULE_1__["addOrdinalNumber"])('.table-user');
          } else {
            _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể xoá được nhân viên');
          }
        });
      } else {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể xoá được nhân viên');
  ...
  $('#search').on('keyup', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/search';
    var value = $(this).val();
    $.ajax({
      type: 'get',
      url: full_path,
  ...
  function search() {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/users/logsearch';
  ...
  $('.delete_all').on('click', function (e) {
    ...
    if (allVals.length <= 0) {
      _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Hãy kích chọn nhân viên muốn xóa');
    } else {
        ...
        $.ajax({
          ...
          success: function success(data) {
            if (data['success']) {
              ...
              _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Xóa đơn nhân viên công');
            } else if (data['error']) {
              alert(data['error']);
            } else {
