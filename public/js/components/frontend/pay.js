...
/***/ "./resources/js/components/frontend/pay.js":
/*!*************************************************!*\
  !*** ./resources/js/components/frontend/pay.js ***!
  \*************************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $('body').on('click', '.create-user-submit', function () {
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/create';
    ...
    if ($('.create-name').val() !== '' && $('.create-email').val() !== '' && $('.create-pass').val() !== '' && $('.create-is-admin').val() !== '' && $('.create-image').val() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
        ...
        success: function success(data) {
          ...
          !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).success('Tạo đơn nhân viên thành công');
          $('#user-append').html(data.data);
          !(function webpackMissingModule() { var e = new Error("Cannot find module './main'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.table-user');
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Lỗi! Không thể tạo nhân viên');
        }
      });
    } else {
      if ($('.create-name').val() === '') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Vui lòng nhập vào tên nhân viên');
      }

      if ($('.create-email').val() === '') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Vui lòng nhập vào email nhân viên');
      }

      if ($('.create-pass').val() === '') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Vui lòng nhập vào mật khẩu');
      }

      if ($('.create-image').val() === '') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Vui lòng chọn ảnh nhân viên');
      }

      if ($('.create-is-admin').val() == '') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Vui lòng chọn chức vụ nhân viên');
      }
    }
  }); ///////END-CREATE////////
  //     ///////*************************************************////////
  ...
  $('body').on('click', '.edit-user-btn', function () {
    ...
    $('.edit-id-user').val(id);
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/detail';
    $.get(full_path, {
      id: id
    }, function (data) {
      // if (data.code && data.code === 200) {
      ...
      var $item = data.path;
      $('.edit-file').append("<div class=\"col-md-1 dbclick-delete-img\"><input type=\"text\" class=\" custom-file-input image-add-again\" id=\"example-file-multiple-input-custom\" data-toggle=\"custom-file-input\" name=\"imagelink[]\" value=\"".concat($item, "\" style=\"display: none\"><img src=\"/").concat($item, "\" style=\"width: 100px; height: 100px; padding-left: 10px; padding-right: 10px; margin-bottom: 10px;\" class=\"edit-image\"></div>"));
    });
    cleanFormEditUser();
  });
  $('body').on('click', '.edit-user-submit', function () {
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/update';
    var formData = new FormData();
    ...
    if ($('.edit-name').val() !== '' && $('.edit-email').val() !== '' && $('.edit-pass').val() !== '' && $('.edit-is-admin').val() !== '' && $('.edit-image-user').val() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
  ...
  $('body').on('click', '.delete-user-submit', function () {
    ...
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/delete';
    $.post(full_path, {
      id: id
    }, function (data) {
      if (data.code && data.code === 200) {
        ...
        var _full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/list?page=' + curPage;

        console.log(_full_path);
        $(trow).remove();
        $.get(_full_path, function (data) {
          if (data.code && data.code === 200) {
            !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).success('Xoá đơn nhân viên thành công');
            $('#user-append').html(data.data);
            !(function webpackMissingModule() { var e = new Error("Cannot find module './main'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.table-user');
          } else {
            !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Lỗi! Không thể xoá được nhân viên');
          }
        });
      } else {
        !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).error('Lỗi! Không thể xoá được nhân viên');
  ...
  $('#search').on('keyup', function () {
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/search';
    var value = $(this).val();
    $.ajax({
      type: 'get',
      url: full_path,
  ...
  function search() {
    var full_path = !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) + '/admin/users/logsearch';
    var is_admin = $('#is_admin').val(); // var account = $('#account').val();
  ...
  $('.delete_all').on('click', function (e) {
    ...
    if (allVals.length <= 0) {
      !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).success('Hãy kích chọn nhân viên muốn xóa');
    } else {
        ...
        $.ajax({
          ...
          success: function success(data) {
            if (data['success']) {
              ...
              !(function webpackMissingModule() { var e = new Error("Cannot find module './config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).success('Xóa đơn nhân viên công');
            } else if (data['error']) {
              alert(data['error']);
            } else {
...
/***/ 4:
/*!*******************************************************!*\
  !*** multi ./resources/js/components/frontend/pay.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\shopnowweb\resources\js\components\frontend\pay.js */"./resources/js/components/frontend/pay.js");
