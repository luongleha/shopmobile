...
/***/ "./resources/js/components/pay_market.js":
/*!***********************************************!*\
  !*** ./resources/js/components/pay_market.js ***!
  \***********************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $('body').on('click', '.add-market-btn', function () {
    var id = $(this).attr('data-id');
    console.log(id);
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/add/' + id;
    ...
    if (id !== '') {
      $.ajax({
        ...
        success: function success(data) {
          location.reload();
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('thành công');
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi!');
        }
      });
    }
  });
  $(".create-money-taken").keydown(function () {
    var totalpay = $('.show-totalpay-product').text();
    var format_totalpay = totalpay.replace(/,/g, "");
    $(".create-excess-cash").val($(this).val() - format_totalpay);
  });
  $(".create-money-taken").keyup(function () {
    var totalpay = $('.show-totalpay-product').text();
    var format_totalpay = totalpay.replace(/,/g, "");
    $(".create-excess-cash").val($(this).val() - format_totalpay);
  });
  $('body').on('click', '.create-bill-market-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/pay';
    var formData = new FormData();
    formData.append('name', $('.create-name').val());
    formData.append('email', $('.create-email').val());
    formData.append('phone', $('.create-phone').val());
    formData.append('address', $('.create-address').val());
    formData.append('money-taken', $('.create-money-taken').val());
    formData.append('excess-cash', $('.create-excess-cash').val());
    console.log($('.create-money-taken').val(), $('.create-excess-cash').val());
    formData.append('qty-product', $('.show-totalnum-product').text());
    var totalpay = $('.show-totalpay-product').text();
    formData.append('totalpay-product', totalpay.replace(/,/g, ""));
    console.log($('.create-name').val());
    console.log($('.create-email').val());
    console.log($('.create-phone').val());
    console.log($('.create-address').val());
    console.log($('.show-totalnum-product').text());
    console.log(totalpay.replace(/,/g, ""));

    if ($('.create-name').val() !== '' && $('.create-phone').val() !== '' && $('.show-totalnum-product').text() !== '' && $('.show-totalpay-product').text() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
        ...
        success: function success(data) {
          // $("#result").text(data);
          $('#createBillMarket').modal('toggle');
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Thanh toán thành công');
          location.reload();
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể thanh toán');
        }
      });
    }
  }); ///////END-CREATE////////
  ...
  //         let full_path = main_url + '/market-pay/detail';
  ...
  $('body').on('click', '.create-again-fb-market-btn', function () {
    ...
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/detail';
    $.get(full_path, {
      id: id
    }, function (data) {
      // if (data.code && data.code === 200) {
      ...
      for (var $i = 0; $i < $length; $i++) {
        // $('.edit-image').src = ('item[]', $item[$i]);
        $('.create-again-file').append("<div class=\"col-md-1 dbclick-delete-img\"><input type=\"text\" class=\" custom-file-input image-add-again\" id=\"example-file-multiple-input-custom\" data-toggle=\"custom-file-input\" name=\"imagelink[]\" value=\"".concat($item[$i], "\" style=\"display: none\"><img src=\"/").concat($item[$i], "\" style=\"width: 100px; height: 100px; padding-left: 10px; padding-right: 10px; margin-bottom: 10px;\" class=\"edit-image\"></div>"));
        console.log($item[$i]);
      }
    });
  ...
  //     let id = $(this).attr('data-id');
  //     let full_path = main_url + '/admin/market-pay/destroy/'+id;
  //     $.post(full_path, {id: id}, function (data) {
  //         if(data.code && data.code === 200) {
  //             let trow = $(store['element']).closest('.cart_item');
  //             let full_path =  main_url + '/admin/market-pay/list?page=' + (curPage);
  //             console.log(full_path);
  //             $(trow).remove();
  ...
  $('body').on('click', '.create-again-fb-market-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/create-again';
    var formData = new FormData();
    ...
    if ($('.edit-sell-fast').prop("checked") == true) {
      $('.edit-sell-fast').attr('value', 1);
    } else if ($('.edit-sell-fast').prop("checked") == false) {
      $('.edit-sell-fast').attr('value', 0);
    }

    formData.append('sell_fast', $('.edit-sell-fast').val());

    if ($('.edit-trends').prop("checked") == true) {
      $('.edit-trends').attr('value', 1);
    } else if ($('.edit-trends').prop("checked") == false) {
      $('.edit-trends').attr('value', 0);
    }

    formData.append('trends', $('.edit-trends').val());
    ...
    if ($('.create-again-name').val() !== '' && $('.create-again-price_origin').val() !== '' && $('.create-again-price_sale').val() !== '' && $('.create-again-category').val() !== '' && $('.create-again-content').val() !== '' && $('.create-again-status').val() !== '' && $('.create-again-image').val() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
        ...
        success: function success(data) {
          ...
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].success('Tạo đơn hàng market thành công');
          $('#fb-market-append').html(data.data);
          Object(_main__WEBPACK_IMPORTED_MODULE_1__["addOrdinalNumber"])('.table-fb-market');
        },
        error: function error(e) {
          // $("#result").text(e.responseText);
          _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Lỗi! Không thể tạo đơn hàng market');
        }
      });
    } else {
      if ($('.create-again-name').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào tên');
      }

      if ($('.create-again-price_origin').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào giá gốc sản phẩm');
      }

      if (isNaN($('.create-again-price_origin').val())) {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào giá gốc sản phẩm bằng số');
      }

      if ($('.create-again-price_sale').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào giá đã giảm của sản phẩm');
      }

      if (isNaN($('.create-again-price_sale').val())) {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập vào giá đã giảm của sản phẩm bằng số');
      }

      if ($('.create-again-content').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng nhập mô tả');
      ...
      if ($('.create-again-status').val() == '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng chọn trạng thái sản phẩm');
      }

      if ($('.create-again-category').val() == '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng chọn danh mục sản phẩm');
      }
    }
  });
  ...
  //     //     // return false;
  //     //     // store['element'] = $(this);
  //     //     let full_path = main_url + '/market-pay/list';
  ...
  $('body').on('click', '.delete-fb-market-submit', function () {
    var id = $('.delete-fb-market-id').val();
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/delete';
    $.post(full_path, {
      id: id
    }, function (data) {
      if (data.code && data.code === 200) {
        ...
        var _full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/list?page=' + curPage;
  ...
  function fetch_data(page) {
    $.ajax({
      url: "/admin/market-pay/list?page=" + page,
      success: function success(data) {
  ...
  $('#search').on('keyup', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/search';
    var value = $(this).val();
    $.ajax({
      type: 'get',
      url: full_path,
  ...
  function search() {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/market-pay/logsearch';
    var cate = $('#cate').val();
    var status = $('#status').val(); // var account = $('#account').val();
  ...
  //     let full_path = main_url + '/market-pay/logsearch';
  //     var $id = $(this).val();
  //     $.ajax({
  //         type : 'get',
  //         url : full_path,
...
/***/ 3:
/*!*****************************************************!*\
  !*** multi ./resources/js/components/pay_market.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\shopmobile\resources\js\components\pay_market.js */"./resources/js/components/pay_market.js");
