...
/***/ "./resources/js/components/fb_market.js":
/*!**********************************************!*\
  !*** ./resources/js/components/fb_market.js ***!
  \**********************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $('body').on('click', '.create-fb-market-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/create';
    ...
    if ($('.create-name').val() !== '' && $('.create-price_origin').val() !== '' && $('.create-price_sale').val() !== '' && $('.create-category').val() !== '' && $('.create-content').val() !== '' && $('.create-image').val() !== '' && $('.create-status').val() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
      ...
      if ($('.create-image').val() === '') {
        _config__WEBPACK_IMPORTED_MODULE_0__["default"].error('Vui lòng chọn ảnh sản phẩm');
      }
  ...
  $('body').on('click', '.create-again-fb-market-btn', function () {
    ...
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/detail';
    $.get(full_path, {
      id: id
    }, function (data) {
      // if (data.code && data.code === 200) {
  ...
  $('body').on('click', '.create-again-fb-market-submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/create-again';
    var formData = new FormData();
    formData.append('id', $('.create-again-id').val()); // console.log($('.create-again-id').val());
  ...
  $('body').on('click', '.delete-fb-market-submit', function () {
    ...
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/delete';
    $.post(full_path, {
      id: id
    }, function (data) {
      if (data.code && data.code === 200) {
        ...
        var _full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/list?page=' + curPage;
  ...
  $('#search').on('keyup', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/search';
    var value = $(this).val();
    $.ajax({
      type: 'get',
      url: full_path,
  ...
  function search() {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/admin/product-market/logsearch';
    var cate = $('#cate').val();
...
/***/ 1:
/*!****************************************************!*\
  !*** multi ./resources/js/components/fb_market.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
