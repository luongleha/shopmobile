...
$(document).ready(function () {
  ...
  $('body').on('click', '.cart_button_checkout_submit', function () {
    var full_path = _config__WEBPACK_IMPORTED_MODULE_0__["main_url"] + '/online/cart/pay';
    console.log(full_path);
    var formData = new FormData();
    ...
    formData.append('qty_product', $('.show-totalnum-product').text());
    var totalpay = $('.show-totalpay-product').text();
    formData.append('totalpay_product', totalpay.replace(/,/g, ""));

    if ($('.create-name').val() !== '' && $('.create-phone').val() !== '' && $('.show-totalpay-product').text() !== '') {
      $.ajax({
        type: "POST",
        url: full_path,
        data: formData,
...
/***/ 7:
/*!**********************************************!*\
  !*** multi ./resources/js/components/pay.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
