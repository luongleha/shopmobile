<div id="footer" class="color-div">
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					<div class="widget">
						<h4 class="widget-title">Mobile Shop</h4>
					</div>
				</div>
				<div class="col-sm-2">
					<div class="widget">
						<h4 class="widget-title">Các Tip</h4>
						<div>
							<ul>
				...
				<div class="col-sm-4">
				 <div class="col-sm-10">
					<div class="widget">
						<h4 class="widget-title">Hỗ trợ từ chúng tôi</h4>
						<div>
							<div class="contact-info">
								<i class="fa fa-map-marker"></i>
								<p>Hà nội, Nguyễn Thị Hoài - Điện thoại: +78 123 456 78</p>
								<p>Luôn sẵn sàng sát cánh cùng bạn.</p>
							</div>
						</div>
					</div>
				  </div>
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-left">Thành lập. (&copy;) 2020</p>
