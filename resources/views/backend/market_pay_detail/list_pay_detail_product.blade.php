        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <div id="fb-market-append">
                    @include('backend.market_pay_detail.list_pay_detail_product_table')
                </div>
            </div>
                    ...
                    <form>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control show-money-taken" disabled>
                                            </div>
                                </div>
                                </div>
                                <div class="col-md-3">
                                <div class="form-group">
                                            ...
                                            Tiền thừa</label>
                                            <div>
                                                <input type="text" class="form-control show-excess-cash" style="border: none" disabled>
                                            </div>
                                </div>
                                </div>
                        </div>
...
@section('scripts')
    ...
    <script src="{{asset('js/components/pay_detail_market.js')}}"></script>
@endsection
