        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <div class="card">
                    <main id="main-container">
                        ...
                        <!-- Page Content -->
                        <div class="content">
                            <h2 class="content-heading"  style="padding-top: 15px;">Doanh thu</h2>
                            ...
                            <div class="block-content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="push">
                                        <label style="font-weight: 600; font-size: 18px; color:black;">Tổng : {{$count}}.&emsp;</label>
                                        </div>
                                    </div>
                                </div>
                      </div>
            ...
            <div class="card-body">
                <div id="fb-market-append">
                    @include('backend.detail_daily_sale.list_detail_daily_sale_table')
                </div>
            </div>
