...
$(document).ready(function () {
    ...
    $('body').on('click', '.add-market-btn', function () {
        ...
        console.log(id);
        let full_path = main_url + '/admin/market-pay/add/'+id;
    ...
    $('body').on('click', '.create-bill-market-submit', function () {
        let full_path = main_url + '/admin/market-pay/pay';
        var formData = new FormData();
        ...
        if ($('.create-name').val() !== '' && $('.create-phone').val() !== '' 
            && $('.show-totalnum-product').text() !== '' && $('.show-totalpay-product').text() !== '') {
            $.ajax({
                type: "POST",
                url: full_path,
                data: formData,
            ...
            error: function (e) {
                ...
                // $("#result").text(e.responseText);
                toastr.error('Lỗi! Không thể thanh toán');
...
//     ///////END-EDIT////////
    ...
    $('body').on('click', '.create-again-fb-market-btn', function () {
        ...
        let full_path = main_url + '/admin/market-pay/detail';
        $.get(full_path, {id: id}, function (data) {
            // if (data.code && data.code === 200) {
    ...
    $('body').on('click', '.create-again-fb-market-submit', function () {
        let full_path = main_url + '/admin/market-pay/create-again';
        var formData = new FormData();
...
//     ///////END-LOG////////
    ...
    $('body').on('click', '.delete-fb-market-submit', function () {
        ...
        let full_path = main_url + '/admin/market-pay/delete';
        $.post(full_path, {id: id}, function (data) {
            if(data.code && data.code === 200) {
    ...
    $('#search').on('keyup',function(){
        let full_path = main_url + '/admin/market-pay/search';
        var value = $(this).val();
        $.ajax({
            type : 'get',
            url : full_path,
    ...
    function search() {
        let full_path = main_url + '/admin/market-pay/logsearch';
        var cate = $('#cate').val();
